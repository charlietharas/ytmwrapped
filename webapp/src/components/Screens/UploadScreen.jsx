            ...
            {cachedCSV ? (
                <div className="upload-split-container">
                    ...
                    >
                        <div className="upload-content">
                            ...
                            <p className="upload-subtitle">
                                ...
                                watch-history.json or processed CSV files here.
                            </p>
                        </div>
                        <input
                            ref={fileInputRef}
                    ...
                    >
                        <div className="upload-content">
                            <p className="upload-icon">📂</p>
                            <p className="upload-title">
                                <strong>Load previous report</strong>
                            </p>
                            <p className="upload-subtitle">
                                Continue with your cached data from the last
                                session.
                            </p>
                        </div>
                    </div>
                ...
                >
                    <div className="upload-content">
                        ...
                        <p className="upload-title">
                            <strong>
                                Select your YouTube Music history file(s)
                            </strong>
                        </p>
                        <p className="upload-subtitle">
                            Click to browse or drag and drop your
                            watch-history.json files here.
                        </p>
                    </div>
                    <input
                        ref={fileInputRef}
