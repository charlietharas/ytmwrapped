...
### User goals:
- Disclaimer section somewhere (likely a different page) to provide clear information about how data is handled and instructions for the process
- Chart zoom buttons when filters are active
